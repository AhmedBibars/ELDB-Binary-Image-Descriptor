...
```
Note that, patch illumination normalization has to be performed for the image before computing its ELDB descriptors. otherwise, both ELDB and LDB will generate the same descriptor for the unnormalized image.
