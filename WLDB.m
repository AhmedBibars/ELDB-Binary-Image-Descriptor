...
AbsDiffxOut=(AbsDiffxMat(ComparisonVector(:,1),1)-AbsDiffxMat(ComparisonVector(:,2),1))>0;
AbsDiffyOut=(AbsDiffyMat(ComparisonVector(:,1),1)-AbsDiffyMat(ComparisonVector(:,2),1))>0;
